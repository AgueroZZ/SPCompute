...
The goal of SPCompute is to compute power and sample size for replication GWAS study, while accommodates different kinds of covariate effects. The methodology used in the software is described in [this paper](https://arxiv.org/abs/2203.15641) by Ziang Zhang and Lei Sun. The detailed implementation guideline can be found in the vignette of this package.
